...
class TestMainFunctionality:
    ...
    def test_constructor_button(self, driver, register_new_user_return_user_data):
        ...
        base_page.waiting_visibility_constructor_button()
    ...
    def test_go_to_order_feed_page(self, driver, register_new_user_return_user_data):
        user_email = register_new_user_return_user_data.get('email')
        user_password = register_new_user_return_user_data.get('password')
    ...
    def test_popup_will_appear_if_click_to_ingredient(self, driver, register_new_user_return_user_data):
        user_email = register_new_user_return_user_data.get('email')
        user_password = register_new_user_return_user_data.get('password')
    ...
    def test_popup_with_ingredient_info_can_be_closed(self, driver, register_new_user_return_user_data):
        user_email = register_new_user_return_user_data.get('email')
        user_password = register_new_user_return_user_data.get('password')
        ...
        home_page.click_fluorescent_bun()
        home_page.waiting_visibility_ingredient_info_popup()
        home_page.waiting_visibility_close_popup_button()
    ...
    def test_ingredient_count_in_basket(self, driver, register_new_user_return_user_data):
        user_email = register_new_user_return_user_data.get('email')
        user_password = register_new_user_return_user_data.get('password')
    ...
    def test_create_order_by_authorized_user(self, driver, register_new_user_return_user_data):
        user_email = register_new_user_return_user_data.get('email')
        user_password = register_new_user_return_user_data.get('password')
